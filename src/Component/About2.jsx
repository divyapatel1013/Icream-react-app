            ...
            <div className="container py-5">
                ...
                <div className="row">
                    <div className="col-lg-4 py-5">
                        ...
                        <p>
                          Since 1950, our family-run ice cream parlor has been serving up happiness in a cone. 
                          ...
                          or adventurous seasonal delights, we have something for everyone.
                        </p>
                        <Link to="#" className="btn btn-secondary mt-2">Learn More</Link>
                    </div>
                    <div className="col-lg-4" style={{ minHeight: "400px" }}>
                        <div className="position-relative h-100 rounded overflow-hidden">
                            <img className="position-absolute w-100 h-100" src="../assets/img/about.jpg" style={{ objectFit: "cover" }} alt="About Us"/>
                        </div>
                    </div>
                    <div className="col-lg-4 py-5">
                        <h4 className="font-weight-bold mb-3">Why Choose Us?</h4>
                        <p>
                          We believe ice cream is more than a treat—it's a way to create cherished memories. 
